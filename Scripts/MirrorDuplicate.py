...
class Mirror_X(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        #Lock and scale -1 across mirroring axis
        ...
        #Restore changed settings for duplicate
...
class VIEW3D_PT_tools_mirrorduplicate(bpy.types.Panel):
...
def register():
    bpy.utils.register_class(VIEW3D_PT_tools_mirrorduplicate)
...
def unregister():
    bpy.utils.unregister_class(VIEW3D_PT_tools_mirrorduplicate)
